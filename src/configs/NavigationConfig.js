...
const basicNavTree = [
  {
    ...
    submenu: [
      {
        key: "basics-default",
        path: `${APP_PREFIX_PATH}/basics/default`,
        title: "sidenav.basic.default",
        icon: DashboardOutlined,
        breadcrumb: false,
        submenu: [],
      },
      ...
      },
      {
        ...
        submenu: [
          {
            key: "basics-clients-clientsList",
          ...
          {
            key: "basics-clients-clientsGroups",
            path: `${APP_PREFIX_PATH}/basics/clients/clientsGroups`,
      ...
      {
        key: "basics-offlinePoints",
        path: `${APP_PREFIX_PATH}/basics/offlinePoints`,
      ...
      },
      {
        ...
        path: `${APP_PREFIX_PATH}/basics/employees`,
      ...
      {
        key: "basics-mailings",
        path: `${APP_PREFIX_PATH}/basics/mailings`,
